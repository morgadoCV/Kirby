...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, uint scale, float speed, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
	if (scale != App->win->GetScale())
	{
